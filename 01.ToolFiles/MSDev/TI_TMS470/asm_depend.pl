...
# %name:            asm_depend.pl %
# created_by:       zzssm0
# date_created:     Mon Jun 12 16:24:37 2006
# %derived_by:      zzssm0 %
# %date_modified:   Mon Jun 12 16:24:37 2006 %
# %version:         1 %
###############################################################################
# executed from within SubProject_TI_TMS470.mak
# 01.ToolFiles\perl 01.ToolFiles\MSDev\TI_TMS470\asm_depend.pl
...
#		  e.g. $(DEPEND_DIR)/<file_basename>.dc - NOT USED
###############################################################################
...
while (<LST>) {
    ...
    # parse for case-insensitive '.include' or '.copy'
    if (/^[ ]+[A-Z]*[ ]+[0-9]+[ ]+[0-9]*[ \t]+(\.[iI][nN][cC][lL][uU][dD][eE]|\.[cC][oO][pP][yY])/)
