...
# created_by:       zzssm0
# date_created:     Mon Jun 14 11:32:05 2004
# %derived_by:      zzssm0 %
# %date_modified:   Fri Sep  1 11:36:01 2006 %
# %version:         kok_pt1#3 %
###############################################################################
# executed from within SubProject_NEC_V850.mak
# 01.ToolFiles\perl5.6.1 01.ToolFiles\MSDev\Nec_V850\c_depend_plus.pl
...
#	ARGV[8] - DEFAULT_NEC_V850_CC_COMMAND_FILE (if no option file is found)
###############################################################################
...
while (<PRE>) {
	...
	$depend_execute = $tools_path . '/' . 'find ' . $include_depend . ' -name ' . $depend_prerequisite[3];
